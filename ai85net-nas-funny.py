...
class AI85NASFunnyNet(nn.Module):
    """
    ...
    def __init__(
        ...
        self.conv1_2 = ai8x.FusedMaxPoolConv2dBNReLU(64, 32, 1, stride=1, padding=0,
                                              bias=bias, batchnorm='NoAffine', **kwargs)
...
def ai85nasfunnynet(pretrained=False, **kwargs):
    """
    Constructs a NAS v1 model.
    """
    assert not pretrained
    return AI85NASFunnyNet(**kwargs)


models = [
    {
        'name': 'ai85nasfunnynet',
        'min_input': 1,
        'dim': 2,
    },
]
...
if __name__ == "__main__":
    model = AI85FunnyNet(num_classes=20, dimensions=(80,80), bias=True)
